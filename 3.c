...
void chiplogo(void )
{
  ...
  *********************************************************************/
  if(DEBUG==1)printf("before enlarge\n");
  enlarge_array(array,x,y,width+2);
  if(DEBUG==1)printf("after enlarge\n");
  if(smooth_before==1){
  ...
  if(error_correct==1){
    ...
    if(DEBUG==1)printf("before error\n");
    find_error(array,array2,x,y,width,space);
    if(DEBUG==1)printf("after error\n");
  ...
  if(DEBUG==1)printf("before shrink\n");
  shrink_array(array,x,y,width+2);
  if(DEBUG==1)printf("after shrink\n");
  ...
  **************************************/
  ...
  if(DEBUG==1)printf("after free\n");
  free(tmp);
  fclose(fpin);
  fclose(fpout);
  if(DEBUG==1)printf("after close\n");
